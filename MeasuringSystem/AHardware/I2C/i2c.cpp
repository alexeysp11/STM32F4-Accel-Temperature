...
/*
* This file contains implementation for I2CBase class.
*/
...
void I2CBase::i2c_setup_gpio(void)
{
	// Set GPIO port mode register for I2C1_SCL and I2C1_SDA as anolog. 
	GPIOB->MODER |= GPIO_MODER_MODER6_1 |   // AF: PB6 => I2C1_SCL
					GPIO_MODER_MODER7_1; 	// AF: PB7 => I2C1_SDA

	// Set GPIO port output type register as output open-drain. 
...
void I2CBase::i2c_read_many(uint8_t address, uint8_t registry, uint8_t * result, uint8_t length)
{
...
void I2CBase::i2c_write(uint8_t address, uint8_t registry, uint8_t data)
{
	I2C1->CR1 |= I2C_CR1_START;				// Generate START condition
...
void I2CBase::i2c_write_many(uint8_t address, uint8_t registry, uint8_t* buf, uint32_t length)
{
	I2C1->CR1 |= I2C_CR1_START;				// Generate START condition
